###############################################################
# FULL CODE RLASSO-IV Simulation codes with P = 50            #
#                                                             # 
###############################################################
...
get_features <- function(N, P) {
  ...
  for (i in 1:P) {
    for (j in 1:P) {
      mysigma[i, j] <- 0.8^abs(i - j) + ifelse(i == j, 0, 0.1)
    }
  }
...
rlasso_iv <- function(x, z, w, y,
  ...
  # ---------------------------------------
  # 4) Tau stage (glmnet) using X_aug
  # ---------------------------------------
...
ggplot(PEHE_summary, aes(x = reorder(Model, mean_PEHE), y = mean_PEHE, group = 1)) +
  ...
  labs(title = "Sample Size N = 2000, Number of Covariates P = 50",
       y = "Mean PEHE", x = "Model") +
  theme_minimal() +
...
ggplot(PEHE_long, aes(x = Model, y = PEHE, fill = Model)) +
  geom_boxplot() + labs(title = "Sample Size N = 2000, Number of Covariates P = 50", y = "PEHE", x = "Model") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
...
ggplot(Bias_long, aes(x = Model, y = Bias, fill = Model)) +
  geom_boxplot() +labs(title = "Sample Size N = 2000, Number of Covariates P = 50", y = "Bias", x = "Model") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
  theme_minimal() + theme(plot.title = element_text(face = "italic", size = 12),
                          axis.title.x = element_text(face = "bold"),
                          axis.title.y = element_text(face = "bold"))
...
ggplot(Bias_long, aes(x = Model, y = Bias)) +
  ...
  theme_minimal() +
  labs(title = "Sample Size N = 000, Number of Covariates P = 50", y = "Bias", x = "Model") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))  +
  theme_minimal() + theme(plot.title = element_text(face = "italic", size = 12),
                          axis.title.x = element_text(face = "bold"),
                          axis.title.y = element_text(face = "bold"))
...
ggplot(PEHE_long, aes(x = Model, y = PEHE)) +
  ...
  geom_boxplot(width = 0.1, fill = "white", outlier.size = 0.5) +
  theme_minimal() +
  labs(title = "Sample Size N = 1000, Number of Covariates P = 50", y = "PEHE", x = "Model") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
  theme_minimal() + theme(plot.title = element_text(face = "italic", size = 12),
                          axis.title.x = element_text(face = "bold"),
                          axis.title.y = element_text(face = "bold"))
